									...
									<div class="card ">
										...
										<div class="card-footer text-center">
											<div class="row user-social-detail">
													<a href="javascript:void(0);" class="social-profile me-4 rounded text-center"><i class="fa fa-facebook" aria-hidden="true"></i></a>

													<a href="javascript:void(0);" class="social-profile me-4 rounded text-center"><i class="fa fa-google-plus" aria-hidden="true"></i></a>

													<a href="javascript:void(0);" class="social-profile me-4 rounded text-center"><i class="fa fa-twitter" aria-hidden="true"></i></a>
											</div>
										</div>
									</div>
								</div><!-- COL END -->
