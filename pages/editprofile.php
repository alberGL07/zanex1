										...
										<div class="card-body">
											<div class="d-flex mb-3">
												...
												<div class="ms-auto mt-xl-2 mt-lg-0 me-lg-2">
													<a href="editprofile.php" class="btn btn-primary btn-sm mt-1 mb-1"><i class="fe fe-camera me-1 float-start"></i>Edit profile</a>
									...
									<div class="card panel-theme">
										...
										<div class="card-body no-padding">
											<ul class="list-group no-margin">
												<li class="list-group-item"><a href="javascript:void(0);"><i class="fa fa-envelope list-contact-icons border text-center br-100"></i> <span class="contact-icons text-dark">support@demo.com</span></a></li>
												<li class="list-group-item"><a href="javascript:void(0);"><i class="fa fa-globe list-contact-icons border text-center br-100"></i><span class="contact-icons text-dark"> www.abcd.com</span></a></li>
												<li class="list-group-item"><a href="javascript:void(0);"><i class="fa fa-phone list-contact-icons border text-center br-100"></i> <span class="contact-icons text-dark">+125 5826 3658 </span></a></li>
											</ul>
										</div>
									</div>
								</div>
