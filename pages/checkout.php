												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<select class="form-control form-select select2" data-bs-placeholder="Select">
															<option label="Select">Choose One</option>
										...
										<div class="card-body">
											<div class="d-flex">
												<div class="d-flex">
													...
													<div class="ms-3 mt-2">
														<h4 class="mb-1 fw-semibold fs-14"><a href="javascript:void(0);">bracelets</a></h4>
											...
											<div class="d-flex mt-5">
												<div class="d-flex">
													...
													<div class="ms-3 mt-2">
														<h4 class="mb-1 fw-semibold fs-14"><a href="javascript:void(0);">Cup</a></h4>
														<div class="mb-2 text-warning fs-14">
															<i class="fa fa-star"></i>
															<i class="fa fa-star"></i>
															<i class="fa fa-star"></i>
											...
											<div class="d-flex mt-5">
												<div class="d-flex">
													...
													<div class="ms-3 mt-2">
														<h4 class="mb-1 fw-semibold fs-14"><a href="javascript:void(0);">Goggles</a></h4>
														<div class="mb-2 text-warning fs-14">
															<i class="fa fa-star"></i>
															<i class="fa fa-star"></i>
															<i class="fa fa-star"></i>
