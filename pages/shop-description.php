										...
										<div class="card-body">
											<div class="productdec text-center">
												<div class="bg-light-gray p-6 text-center br-5">
													<img alt="Product" src="../assets/images/pngs/31.png">
												</div>
											</div>
											<div class="text-center mt-5 pb-5 border-bottom">
												<a href="cart.php" class="btn btn-primary"><i class="ti-shopping-cart"> </i> Add to cart</a>
												<a href="javascript:void(0);" class="btn btn-secondary"><i class="ti-shopping-cart"> </i> Buy Now</a>
											</div>
													...
													<div class="tab-content">
														<div class="tab-pane active" id="tab1">
															...
															<ul class="list-unstyled mb-0">
																<li class="row">
																	<div class="col-sm-3 col-lg-4 col-xl-3 text-muted">Brand</div>
																	<div class="col-sm-3 col-lg-8 col-xl-3">CASAMOTION</div>
																</li>
																<li class=" row">
																	<div class="col-sm-3 col-lg-4 col-xl-3 text-muted">Model Number</div>
																	<div class="col-sm-3 col-lg-8 col-xl-3">AHLF016</div>
																</li>
																<li class="p-b-20 row">
																	<div class="col-sm-3 col-lg-4 col-xl-3 text-muted">Model Name</div>
																	<div class="col-sm-3 col-lg-8 col-xl-3">casamotion</div>
																</li>
																<li class="p-b-20 row">
																	<div class="col-sm-3 col-lg-4 col-xl-3 text-muted">Suitable For</div>
																	<div class="col-sm-3 col-lg-8 col-xl-3">Table, Floor</div>
																</li>
																<li class="p-b-20 row">
																	<div class="col-sm-3 col-lg-4 col-xl-3 text-muted">Material</div>
																	<div class="col-sm-3 col-lg-8 col-xl-3">Wood</div>
																</li>
																<li class="p-b-20 row">
																	<div class="col-sm-3 col-lg-4 col-xl-3 text-muted">Color</div>
														...
														<div class="tab-pane" id="tab2">
															<ul class="list-unstyled mb-0">
																<li class="row">
																	<div class="col-sm-3 col-lg-4 col-xl-3 text-muted">Width</div>
																	<div class="col-sm-3 col-lg-8 col-xl-3">6.1 inch</div>
																</li>
																<li class=" row">
																	<div class="col-sm-3 col-lg-4 col-xl-3 text-muted">Height</div>
																	<div class="col-sm-3 col-lg-8 col-xl-3">24 inch</div>
																</li>
																<li class="p-b-20 row">
																	<div class="col-sm-3 col-lg-4 col-xl-3 text-muted">Depth</div>
																	<div class="col-sm-3 col-lg-8 col-xl-3">6.1 inch</div>
																</li>
																<li class="p-b-20 row">
																	<div class="col-sm-3 col-lg-4 col-xl-3 text-muted">Other Dimensions</div>
																	<div class="col-sm-3 col-lg-8 col-xl-3">15.5*15.5*24CM</div>
																</li>
															</ul>
														</div>
											...
											<div id="carouselExampleControls" class="carousel slide  p-2 border" data-bs-ride="carousel">
												<div class="carousel-inner">
													<div class="carousel-item">
														<img class="pro_img br-5" alt="Product" src="../assets/images/pngs/1.png">
														<div class="carouselproduct mt-4 text-center pb-4">
															<h5 class=""><a href="shop.php">Cup</a></h5>
															...
															<a href="javascript:void(0);" class="btn btn-primary"><i class="ti-shopping-cart"></i> Buy Now</a>
														</div>
													</div>
													<div class="carousel-item active">
														<img class="pro_img br-5 " alt="Product" src="../assets/images/pngs/2.png">
														<div class="carouselproduct mt-4 text-center  pb-4">
															<h5 class=""><a href="shop.php">Video Game</a></h5>
															<ul class="product_price list-unstyled">
													...
													<div class="carousel-item">
														<img class="pro_img productborder br-5" alt="Product" src="../assets/images/pngs/3.png">
														<div class="carouselproduct mt-4 text-center pb-4">
															<h5 class=""><a href="shop.php">Headset</a></h5>
															<ul class="product_price list-unstyled">
													...
													<div class="carousel-item">
														<img class="pro_img productborder  br-5" alt="Product" src="../assets/images/pngs/4.png">
														<div class="carouselproduct mt-4 text-center pb-4">
															<h5 class=""><a href="shop.php">Flower pot</a></h5>
															<ul class="product_price list-unstyled">
															...
															<a href="javascript:void(0);" class="btn btn-info"><i class="ti-shopping-cart"></i> Buy Now</a>
														</div>
													</div>
													<div class="carousel-item">
														<img class="pro_img productborder  br-5" alt="Product" src="../assets/images/pngs/5.png">
														<div class="carouselproduct mt-4 text-center pb-4">
															<h5 class=""><a href="shop.php">Royal Chair</a></h5>
															<ul class="product_price list-unstyled">
															...
															<a href="javascript:void(0);" class="btn btn-danger"><i class="ti-shopping-cart"> </i> Buy Now</a>
														</div>
													</div>
													<div class="carousel-item">
														<img class="pro_img productborder  br-5" alt="Product" src="../assets/images/pngs/6.png">
														<div class="carouselproduct mt-4 text-center pb-4">
															<h5 class=""><a href="shop.php">Goggles</a></h5>
															<ul class="product_price list-unstyled">
															...
															<a href="javascript:void(0);" class="btn btn-warning"><i class="ti-shopping-cart"> </i> Buy Now</a>
														</div>
													</div>
													<div class="carousel-item">
														<img class="pro_img productborder  br-5" alt="Product" src="../assets/images/pngs/7.png">
														<div class="carouselproduct mt-4 text-center pb-4">
															<h5 class=""><a href="shop.php">Stool</a></h5>
															<ul class="product_price list-unstyled">
													...
													<div class="carousel-item">
														<img class="pro_img productborder  br-5" alt="Product" src="../assets/images/pngs/8.png">
														<div class="carouselproduct mt-4 text-center pb-4">
															<h5 class=""><a href="shop.php">Headset</a></h5>
															<ul class="product_price list-unstyled">
