						...
						<div class="main-container container-fluid">
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="text-wrap">
												...
												<div class="example">
													<div class="btn-list">
														<a href="javascript:void(0);" class="btn btn-outline-default">Primary</a>
							...
							<div  class="row">
								...
								<div class="col-md-6 ">
									<div class="card">
										<div class="card-header">
											<h3 class="card-title">Min-Width Button</h3>
										</div>
										<div class="card-body">
											<div class="text-wrap">
												<p>Add <code class="highlighter-rouge">.btn</code>, <code class="highlighter-rouge">.w-xs</code>, <code class="highlighter-rouge">.w-sm</code>, <code class="highlighter-rouge">.w-md</code>, <code class="highlighter-rouge">.w-lg</code>, classes to quickly create a styled button..</p>
												<div class="example">
													<div class="btn-list">
								...
								<div class="col-md-12 ">
									<div class="card">
										<div class="card-header">
											<h3 class="card-title">Block Level Buttons</h3>
										</div>
										<div class="card-body">
											<div class="text-wrap">
