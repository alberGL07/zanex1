					...
					<div class="side-app">
						...
						<div class="main-container container-fluid">
                            ...
                            <div class="row">
                                <div class="col-xl-8">
                                    <div class="card">
                                        <img class="card-img-top br-7 br-bl-0 br-br-0" src="../assets/images/media/blog11.jpg" alt="Card image cap">
                                        <div class="card-body">
                                            <div class="d-md-flex">
                                            ...
                                            <div class="media mb-5 overflow-visible d-block d-sm-flex">
                                                ...
                                                <div class="media-body overflow-visible">
                                                    <div class="border mb-5 p-4 br-5">
                                                        ...
                                                        <h5 class="mt-0">Florinda Carasco</h5>
                                                        ...
                                                        <a class="like" href="javascript:void(0);">
                                                            <span class="badge btn-danger p-2">
                                                                <i class="fe fe-heart mx-1"></i>Like</span>
                                                        </a>
                                                        <span class="reply" id="1">
                                                            <a href="javascript:void(0);"><span class="badge btn-primary p-2"><i class="fe fe-corner-up-left mx-1"></i>Reply</span></a>
                                                        </span>
                                                    </div>
                                                    <div class="media mb-5 overflow-visible">
                                                        ...
                                                        <div class="media-body border p-4 overflow-visible br-5">
                                                            ...
                                                            <a class="like" href="javascript:void(0);"><span class="badge btn-danger p-2"><i class="fe fe-heart mx-1"></i>Like</span></a>
                                            ...
                                            <div class="media mb-5 overflow-visible">
                                                ...
                                                <div class="media-body overflow-visible">
                                                    <div class="border mb-5 p-4 br-5">
                                                        ...
                                                        <h5 class="mt-0">Alina Bernier</h5>
                                ...
                                <div class="col-xl-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-group">
                                                    <li class="list-group-item border list-icon"><a href="javascript:void(0)" class="text-dark mx-3"> Business</a> <span class="product-label">11</span> </li>
                                                    <li class="list-group-item border list-icon"><a href="javascript:void(0)" class="text-dark mx-3"> Gadgets</a> <span class="product-label">46</span> </li>
                                                    <li class="list-group-item border list-icon"><a href="javascript:void(0)" class="text-dark mx-3"> Fashion</a> <span class="product-label">25</span> </li>
                                                    <li class="list-group-item border list-icon"><a href="javascript:void(0)" class="text-dark mx-3"> Political</a> <span class="product-label">73</span> </li>
                                            </ul>
                                        </div>
                                    </div>
