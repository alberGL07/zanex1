							...
							<div class="row">
								...
								<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
									<div class="card">
										...
										<div class="card-body pt-0 pb-0 border-top-0 overflow-hidden">
											<div class="chart-wrapper overflow-hidden ">
												<canvas id="areaChart2" class="areaChart overflow-hidden chart-dropshadow-success"></canvas>
											</div>
										</div>
									</div>
								</div><!-- COL END -->
								<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
									<div class="card">
										...
										<div class="card-body pt-0 pb-0 border-top-0 overflow-hidden">
											<div class="chart-wrapper  overflow-hidden">
												<canvas id="areaChart3" class="areaChart overflow-hidden chart-dropshadow-warning"></canvas>
											</div>
										</div>
									</div>
								</div><!-- COL END -->
								<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
									<div class="card">
										...
										<div class="card-body pt-0 pb-0 border-top-0 overflow-hidden">
											<div class="chart-wrapper  overflow-hidden">
												<canvas id="areaChart4" class="areaChart overflow-hidden chart-dropshadow-danger"></canvas>
											</div>
										</div>
									</div>
								</div><!-- COL END -->
							...
							<div class="row">
								<div class="col-sm-12 col-md-12 col-lg-6  col-xl-3">
									<div class="card widgets-cards bg-primary box-primary-shadow">
										<div class="card-body d-flex text-center align-items-center">
											<div class="chart-circle chart-circle-sm me-4 mt-1" data-value="0.62" data-thickness="6" data-bs-color="#321773"><div class="chart-circle-value text-white">70%</div></div>
								...
								<div class="col-sm-12 col-md-12 col-lg-6  col-xl-3">
									<div class="card widgets-cards bg-success box-success-shadow">
										<div class="card-body d-flex text-center align-items-center">
											<div class="chart-circle chart-circle-sm me-4 mt-1" data-value="0.37" data-thickness="6" data-bs-color="#0e8c79"><div class="chart-circle-value text-white">17%</div></div>
											<div class="wrp text-wrapper text-white">
												<p class="mt-0">6477</p>
								...
								<div class="col-sm-12 col-md-12 col-lg-6  col-xl-3">
									<div class="card widgets-cards bg-warning box-warning-shadow">
										<div class="card-body d-flex text-center align-items-center">
											<div class="chart-circle chart-circle-sm me-4 mt-1" data-value="0.42" data-thickness="6" data-bs-color="#c68806"><div class="chart-circle-value text-white">42%</div></div>
											<div class="wrp text-wrapper text-white">
												<p class="mt-0">7847</p>
								...
								<div class="col-sm-12 col-md-12 col-lg-6  col-xl-3">
									<div class="card widgets-cards bg-danger box-danger-shadow">
										<div class="card-body d-flex text-center align-items-center">
											<div class="chart-circle chart-circle-sm me-4 mt-1" data-value="0.42" data-thickness="6" data-bs-color="#c21a1a"><div class="chart-circle-value text-white">37%</div></div>
											<div class="wrp text-wrapper text-white">
												<p class="mt-0">345</p>
									...
									<div class="card ">
										...
										<div class="card-body">
											...
											<div class="media mb-5 mt-0">
												...
												<div class="media-body">
													<a href="javascript:void(0);" class="text-dark">Bustos</a>
													<div class="text-muted small">Manager</div>
												</div>
