                                        ...
                                        <div class="card-body h-100">
                                            <div id="carousel-default" class="carousel slide" data-bs-ride="carousel">
                                                <div class="carousel-inner">
                                                    ...
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" alt="" src="../assets/images/media/21.jpg" data-bs-holder-rendered="true">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" alt="" src="../assets/images/media/22.jpg" data-bs-holder-rendered="true">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" alt="" src="../assets/images/media/23.jpg" data-bs-holder-rendered="true">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body h-100">
                                            <div id="carousel-indicators" class="carousel slide" data-bs-ride="carousel">
                                                ...
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img class="d-block w-100" alt="" src="../assets/images/media/24.jpg" data-bs-holder-rendered="true">
                                                    </div>
                                                    <div class="carousel-item">
                                                        <img class="d-block w-100" alt="" src="../assets/images/media/25.jpg" data-bs-holder-rendered="true">
                                                    </div>
                                                    <div class="carousel-item">
