												...
												<div class="tab-content main-chat-list">
													<div class="tab-pane active" id="ChatList">
														<div class="main-chat-list tab-pane">
															...
															<a class="media new" href="javascript:void(0);">
																<div class="main-img-user"><img alt="" src="../assets/images/users/11.jpg"></div>
																<div class="media-body">
																	<div class="media-contact-name">
															...
															<a class="media new" href="javascript:void(0);">
																<div class="main-img-user">
																	<img alt="" src="../assets/images/users/7.jpg"> <span>1</span>
																</div>
																<div class="media-body">
																	<div class="media-contact-name">
															...
															<a class="media new" href="javascript:void(0);">
																<div class="main-img-user"><img alt="" src="../assets/images/users/8.jpg"></div>
																<div class="media-body">
																	<div class="media-contact-name">
															...
															<a class="media new" href="javascript:void(0);">
																<div class="main-img-user"><img alt="" src="../assets/images/users/12.jpg"></div>
																<div class="media-body">
																	<div class="media-contact-name">
													...
													<div class="tab-pane" id="ChatCalls">
														...
														<div class="d-flex align-items-center media">
															<div class="mb-0 me-2">
																<div class="main-img-user online">
																	<img alt="" src="../assets/images/users/8.jpg"> <span>2</span>
																</div>
															</div>
															<div class="align-items-center justify-content-between">
																<div class="media-body ms-2">
											...
											<div class="main-content-body main-content-body-chat">
												...
												<div class="main-chat-footer">
													<nav class="nav">
														...
														<a class="nav-link" data-bs-toggle="tooltip" href="javascript:void(0);" title="Emoji"><i class="fa fa-smile-o"></i></a>
													...
													<a class="main-msg-send" href="javascript:void(0);"><i class="fa fa-paper-plane-o"></i></a>
												</div>
											</div>
										</div>
									</div>
